...
You can configure it in the system.webServer/handlers section of your web.config like so:
...
... which will generate one JavaScript files per package and store them in jspkg. Assuming the previous configuration this would produce:
